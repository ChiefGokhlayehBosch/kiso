...
TEST_F(TS_PopUntil, CrNearEndOfString_Success)
{
    ...
    Retcode_T rc = PopUntil(&t, actData, &actDataLen, needle, NULL, NULL);
...
TEST_F(TS_PopUntil, CrInSecondMessage_Success)
{
    ...
    Retcode_T rc = PopUntil(&t, actData, &actDataLen, needle, NULL, &tickLimit);
...
TEST_F(TS_SkipUntil, CrNearEndOfString_Success)
{
    ...
    Retcode_T rc = SkipUntil(&t, needle, &found, NULL);

    ASSERT_EQ(RETCODE_OK, rc);
    ASSERT_EQ(needle[0], ((const char *)found)[0]);
}
...
TEST_F(TS_SkipUntil, CrInSecondMessage_Success)
{
    ...
    Retcode_T rc = SkipUntil(&t, needle, &found, &tickLimit);
...
TEST_F(TS_SkipUntil, OneMsgWithTimeout_Fail)
{
    ...
    Retcode_T rc = SkipUntil(&t, needle, NULL, &tickLimit);
...
TEST_F(TS_Skip, OneMsg_Success)
{
    ...
    ASSERT_EQ(expAmount, r);
    ASSERT_EQ(expDataLen - expAmount, this->GetFakeRxByteCount());
}
...
TEST_F(TS_AtTransceiver_ReadCommandAny, LargeBuffer_Success)
{
    ...
    ASSERT_EQ(RETCODE_OK, rc);
    ASSERT_EQ(expDataLen, strnlen(actData, sizeof(actData)));
}
...
TEST_F(TS_AtTransceiver_ReadCommandAny, CantFitZeroTerminator_Warn)
{
    ...
    ASSERT_EQ(RETCODE(RETCODE_SEVERITY_WARNING, RETCODE_OUT_OF_RESOURCES), rc);
    ASSERT_EQ(expDataLen - 1, strnlen(actData, sizeof(actData)));
}
...
TEST_F(TS_AtTransceiver_ReadCommandAny, BufferTooSmall_Warn)
{
    ...
    ASSERT_EQ(RETCODE(RETCODE_SEVERITY_WARNING, RETCODE_OUT_OF_RESOURCES), rc);
    ASSERT_EQ(expDataLen / 2, strnlen(actData, sizeof(actData)));
}
...
TEST_F(TS_AtTransceiver_ReadCommandAny, BufferCanOnlyHoldZeroTerminator_Warn)
{
    ...
    ASSERT_EQ(RETCODE(RETCODE_SEVERITY_WARNING, RETCODE_OUT_OF_RESOURCES), rc);
    ASSERT_EQ(0U, strnlen(actData, sizeof(actData)));
}
...
TEST_F(TS_AtTransceiver_ReadCommand, COPS_Success)
{
    ...
    ASSERT_EQ(RETCODE_OK, rc);
    ASSERT_EQ(totalData.length() - totalData.find(':') - 1, this->GetFakeRxByteCount());
}
...
#define ATTRANSCEIVER_INT_TEST_FIXTURE_EXP(NAME, BITSIZE, EXPECTED, BASE)                    \
    ...
    {                                                                                        \
        ...
        ASSERT_EQ(RETCODE_OK, rc);                                                           \
        ASSERT_EQ(expX, x);                                                                  \
        ASSERT_FALSE(AtTransceiver_IsStartOfLine(&t));                                       \
    }                                                                                        \
                                                                                             \
    ...
    {                                                                                        \
        ...
        ASSERT_EQ(RETCODE_OK, rc);                                                           \
        ASSERT_EQ(expX, x);                                                                  \
        ASSERT_TRUE(AtTransceiver_IsStartOfLine(&t));                                        \
    }                                                                                        \
                                                                                             \
...
class TS_AtTransceiver_ReadArgument : public TS_FakeRx
{
};

TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument__When__reading_argument__Then__obtain_argument__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << expData << ", 123\r\n";
    ...
    Retcode_T rc = AtTransceiver_ReadArgument(&t, actData, sizeof(actData), 0);
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__last_argument_in_response__When__reading_argument__Then__obtain_argument__last_argument_separator_eol__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << expData << "\r\n";
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument_with_leading_whitespace__When__reading_argument__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << " " << expData << ", 123\r\n";
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument_with_arbitrary_internal_whitespace__When__reading_argument__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello    World";
    stringstream ss;
    ss << " " << expData << ", 123\r\n";
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument_with_trailing_whitespace__When__reading_argument__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << expData << " , 123\r\n";
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument_with_leading_and_trailing_whitespace__When__reading_argument__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << " " << expData << " , 123\r\n";
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument_with_arbitrary_leading_and_trailing_whitespace__When__reading_argument__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << "            " << expData << "     , 123\r\n";
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument_with_arbitrary_leading_and_trailing_whitespace__When__reading_argument_with_buffer_one_byte_bigger_than_needed__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << "            " << expData << "    , 123\r\n";
    string totalData = ss.str();
    char actData[expData.length() + 2]; // +1 extra byte
    memset(actData, 'A', sizeof(actData));
    this->EnqueueMessage(totalData);
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__non_quoted_string_argument_with_arbitrary_leading_and_trailing_whitespace__When__reading_argument_with_large_buffer__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello World";
    stringstream ss;
    ss << "            " << expData << "     , 123\r\n";
    string totalData = ss.str();
    char actData[expData.length() * 2 + 1]; // 100% extra bytes
    memset(actData, 'A', sizeof(actData));
    this->EnqueueMessage(totalData);
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__single_word_string_argument_with_arbitrary_leading_and_trailing_whitespace__When__reading_argument__Then__obtain_argument_without_whitespace__return_ok)
{
...
TEST_F(TS_AtTransceiver_ReadArgument, Given__multi_word_string_argument_with_arbitrary_leading_and_trailing_whitespace__When__reading_argument__Then__obtain_argument_without_whitespace__return_ok)
{
    string expData = "Hello World      some whitespace     Hello World!";
    stringstream ss;
    ss << "            " << expData << "     , 123\r\n";
    string totalData = ss.str();
    char actData[expData.length() + 1];
...
TEST_F(TS_AtTransceiver_ReadString, Given__some_string__last_argument__last_argument__When__reading_string__Then__obtain_string__last_arg_separator_eol__return_ok)
{
    string totalData = "\"Hello World!\"\r\n";
    string expData = totalData.substr(totalData.find("\"") + 1);
    expData = expData.substr(0, expData.find("\""));
    char actData[expData.length() + 1];
    memset(actData, 'A', sizeof(actData));
...
TEST_F(TS_AtTransceiver_ReadString, CantFitZeroTerminator_Fail)
{
    ...
    ASSERT_EQ(RETCODE(RETCODE_SEVERITY_ERROR, RETCODE_OUT_OF_RESOURCES), rc);
    ASSERT_EQ('A', actData[sizeof(actData) - 1]);
    ASSERT_FALSE(AtTransceiver_IsStartOfLine(&t));
}

TEST_F(TS_AtTransceiver_ReadString, Given__some_string_argument__When__reading_string_with_zero_length_buffer__Then__dont_consume_rx_bytes__return_invalid_parameter_error)
{
    string totalData = "\"Hello World!\",123\r\n";
    string expData = totalData.substr(totalData.find("\"") + 1);
    expData = expData.substr(0, expData.find("\""));
    ...
    Retcode_T rc = AtTransceiver_ReadString(&t, actData, 0, 0);

    ASSERT_EQ(RETCODE(RETCODE_SEVERITY_ERROR, RETCODE_INVALID_PARAM), rc);
    ASSERT_EQ(GetFakeRxByteCount(), totalData.length());
    ASSERT_FALSE(AtTransceiver_IsStartOfLine(&t));
}
...
TEST_F(TS_AtTransceiver_ReadHexString, Given__large_hex_string__last_argument__When__reading_hex_string__Then__obtain_decoded_hex_data__last_arg_separator_eol__return_ok)
{
    string expData = "This should be decoded from hex!";
    stringstream ss;
    ss << "\"";
...
TEST_F(TS_AtTransceiver_ReadHexString, LargeStringEarlyEnd_Success)
{
    string expData = "This should be decoded from hex!";
    stringstream ss;
    ss << "\"";
    ...
    char actData[(expData.length() + 1) * 2];
    memset(actData, 'A', sizeof(actData));
    size_t numActualBytesRead = 0;
    Retcode_T rc = AtTransceiver_ReadHexString(&t, actData, sizeof(actData) - 1, &numActualBytesRead, 0);

    ASSERT_EQ(RETCODE_OK, rc);
    ASSERT_LE(numActualBytesRead, sizeof(actData));
    actData[numActualBytesRead] = '\0';
    ASSERT_EQ(expData.length(), numActualBytesRead);
    ASSERT_STREQ(expData.c_str(), actData);
    ASSERT_FALSE(AtTransceiver_IsStartOfLine(&t));
}
...
class TS_AtTransceiver_CheckEndOfLine : public TS_FakeRx
{
};

TEST_F(TS_AtTransceiver_CheckEndOfLine, Given__pointing_to_eof__When__checking_eof__Then__set_result__return_ok)
{
    bool eol = false;

    string totalData = ATTRANSCEIVER_S3S4;
    this->EnqueueMessage(totalData);

    Retcode_T rc = AtTransceiver_CheckEndOfLine(&this->t, &eol, 0);
...
TEST_F(TS_AtTransceiver_CheckEndOfLine, Given__not_pointing_to_eof__When__checking_eof__Then__set_result__return_ok)
{
    bool eol = true;

    stringstream ss;
    ss << "not end of line" << ATTRANSCEIVER_S3S4;
    string totalData = ss.str();
    this->EnqueueMessage(totalData);
...
class TS_AtTransceiver_SkipLine : public TS_FakeRx
{
};

TEST_F(TS_AtTransceiver_SkipLine, Given__start_of_full_URC_response__When__skipping_line__Then__drop_response__stop_on_empty_line__return_ok)
{
    string expConsumed = "+CREG: 0, 4" ATTRANSCEIVER_S3S4 "";
    stringstream ss;
    ss << expConsumed << ATTRANSCEIVER_S3S4;
    string totalData = ss.str();
    this->EnqueueMessage(totalData);

    Retcode_T rc = AtTransceiver_SkipLine(&this->t, 0);

    ASSERT_EQ(RETCODE_OK, rc);
    ASSERT_EQ(GetFakeRxByteCount(), totalData.substr(expConsumed.length()).length());
    ASSERT_TRUE(AtTransceiver_IsStartOfLine(&t));
}

TEST_F(TS_AtTransceiver_SkipLine, Given__somewhere_inside_of_full_URC_response__When__skipping_line__Then__drop_response__stop_on_empty_line__return_ok)
{
    string expConsumed = "0, 4" ATTRANSCEIVER_S3S4 "";
    stringstream ss;
    ss << expConsumed << ATTRANSCEIVER_S3S4;
    string totalData = ss.str();
    this->EnqueueMessage(totalData);
