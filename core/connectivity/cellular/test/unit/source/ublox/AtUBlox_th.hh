...
/* *** HTTP SERVICE ********************************************************* */
FAKE_VALUE_FUNC(Retcode_T, At_Set_UHTTP, const AT_UHTTP_Param_T *);
FAKE_VALUE_FUNC(Retcode_T, At_Set_UHTTPC, const AT_UHTTPC_Param_T *);
/* *** FILE HANDLING ******************************************************** */
FAKE_VALUE_FUNC(Retcode_T, At_Set_UDWNFILE, const AT_UDWNFILE_Param_T *);
FAKE_VALUE_FUNC(Retcode_T, At_Set_UDELFILE, const AT_UDELFILE_Param_T *);
FAKE_VALUE_FUNC(Retcode_T, At_Set_ULSTFILE, AT_ULSTFILE_Param_T *);
FAKE_VALUE_FUNC(Retcode_T, At_Set_URDBLOCK, const AT_URDBLOCK_Param_T *, AT_URDBLOCK_Resp_T *)
FAKE_VALUE_FUNC(Retcode_T, At_Set_URDFILE, AT_URDFILE_Param_T *)
/* *** RADIO CONFIGURATION ************************************************** */
...
/* *** HW TESTING *********************************************************** */
FAKE_VALUE_FUNC(Retcode_T, At_Set_UTEST, uint32_t);
/* *** URC HANDLERS ********************************************************* */
